...
class Genealogy_Individual
{
    ...
    function getIdent(){ return $this->Identifier; }
    function getTitle(){ return $this->Title; }
    
    function getBirthDate(){ return $this->Birth['Date']; }
    function getBirthPlace(){ return $this->Birth['Place']; }
    function getBirthSource(){ return $this->Birth['Source']; }
    function getBirthNote(){ return $this->Birth['Note']; }
    
    function getDeathDate(){ return $this->Death['Date']; }
    function getDeathPlace(){ return $this->Death['Place']; }
    function getDeathSource(){ return $this->Death['Source']; }
    function getDeathNote(){ return $this->Death['Note']; }
    
    function getFCDate(){ return $this->FirstCommunion['Date']; }
    function getFCPlace(){ return $this->FirstCommunion['Place']; }
    function getFCSource(){ return $this->FirstCommunion['Source']; }
    function getFCNote(){ return $this->FirstCommunion['Note']; }
    
    function getOccupation(){ return $this->Occupation; }
    function getSource(){ return $this->Source; }
    function getObject(){ return $this->Object; }
    function getFamSpouse(){ return $this->FamilySpouse; }
    function getFamChild(){ return $this->FamilyChild; }
    function getNationality(){ return $this->Nationality; }
    function getNote(){ return $this->Note; }
    function getSex(){ return $this->Sex; }
    
    function getBurialDate(){ return $this->Burial['Date']; }
    function getBurialPlace(){ return $this->Burial['Place']; }
